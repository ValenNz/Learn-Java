...
public class OperasiString {
    public static void main(String[] args) {
        ...
        kata = kata + " cireng"; // menimpa string
        System.out.println(kata);

        // concat dengan non string
        int jumlah = 20;
        String kalimat3 = kata + " " + jumlah; // casting int to string
        System.out.println(kalimat3);
        System.out.println(kata + " " + jumlah); // casting

        // lowercase dan uppercase
        System.out.println(kalimat.toUpperCase()); // Memperbesar kalimat (kapital)
        System.out.println(kalimat.toLowerCase()); // Memperkecil kalimat

        // replace (menganti komponen menjadi komponen lain)
        String kalimat4 = kalimat.replace("pisang","combro");
        System.out.println(kalimat);  // sebelum replace
        System.out.println(kalimat4); // setelah replace

        // Compare (membandingkan string berdasarkan urutan alphabethic)
        ...
        // equality ( persamaan ) cek persamaan kata
...
//        String kataInput = new String("test"); // ini bukan string literal, dan tidak berada di string pool
        ...
        if (kataInput.equals(kataTest)){ // equals membiarkan besar kecilnya huruf
            System.out.println("sama");
        } else {
            System.out.println("tidak sama");
        }
